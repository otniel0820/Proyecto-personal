...
const EjercicioPecho = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full py-10 px-4 lg:px-10 lg:py-20 gap-8 bg-white shadow-lg shadow-red-500 rounded-lg">
      ...
      <section className="flex flex-col lg:flex-row gap-8 items-center">
        <img
          src="https://i.pinimg.com/originals/22/6f/8b/226f8bed78eb03d988c67bbe2bfff9e0.gif"
          alt=""
          className="w-full lg:w-[30em] xl:w-[30em]"
        />
        <img
          src="https://i.pinimg.com/564x/df/7d/c3/df7dc392da5f4d3fcaa5f02cb60dd3d5.jpg"
          alt=""
          className="w-full lg:w-[30em] xl:w-[30em]"
        />
